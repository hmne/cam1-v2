...
<head>
    ...
    <title><?= CAMERA_DISPLAY_NAME ?> Control Center [NO JQUERY TEST]</title>
        ...
        <div class="glass-panel">
            <div id="myForm" style="display: none">
                <form method="post" action="<?= escapeHtml($_SERVER['PHP_SELF']) ?>">
                    <center><p>
                        <label for="webLiveSelect" class="ctl-label">Live</label>
                        <select name="web_live" id="webLiveSelect" class="ctl-select">
                        ...
                        <select name="res" id="res" class="ctl-select">
                        ...
                        <select name="comp" id="comp" class="ctl-select">
                        ...
                        <select name="iso" id="iso" class="ctl-select">
                        ...
                        <select name="sat" id="sat" class="ctl-select">
                        ...
                        <select name="rot" id="rot" class="ctl-select">
                        ...
                        <select name="fx" id="fx" class="ctl-select">
                        ...
                        <select name="enf" id="enf" class="ctl-select">
                        ...
                        <div id="webLiveContainer" class="glass-panel" style="display:none; margin-top:10px; margin-bottom:10px;">
                            ...
                            <div id="liveQualityOptions" style="margin-top:10px;">
                                ...
                                <select name="liveQuality" id="liveQuality" class="ctl-select">
                        ...
                        <button id="myBut" type="button" class="glass-red-button">Capture</button>
